...
export const AUTH_INPUT_CLASS =
  "w-full rounded-lg border-[1.5px] border-slate-200 bg-[#FAFAFA] pl-4 pr-10 py-2.5 " +
...
export const AUTH_LINK_CLASS =
  "-my-1.5 inline-block py-1.5 text-[13px] font-medium text-[#2563C4] no-underline hover:underline";
